...
public class FirstHalfCheckSumCalculator {
    ///////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////
    // Attributes
    ///////////////////////////////////////////////////////////////////////////
    ...
    public static void main(String[] args) {
        final FirstHalfCheckSumCalculator calculator = new FirstHalfCheckSumCalculator("3093\t749\t3469\t142\t2049\t3537\t1596\t3035\t2424\t3982\t3290\t125\t249\t131\t118\t3138\n" +
    ...
    public FirstHalfCheckSumCalculator() {
    
    }
    
    public FirstHalfCheckSumCalculator(final String numberLists) {
    ...
    public int getHighestNumber(final ArrayList<Integer> numbers) {
        final ArrayList<Integer> copyOfNumbers = (ArrayList<Integer>) numbers.clone();
        Collections.sort(copyOfNumbers);
        return copyOfNumbers.get(copyOfNumbers.size() - 1);
    }
    
    public int getLowestNumber(final ArrayList<Integer> numbers) {
        final ArrayList<Integer> copyOfNumbers = (ArrayList<Integer>) numbers.clone();
        Collections.sort(copyOfNumbers);
        return copyOfNumbers.get(0);
    }
    ...
    public int getChecksum() {
        ...
        for (ArrayList<Integer> numbers : values) {
            checksum += getHighestNumber(numbers) - getLowestNumber(numbers);
        }
